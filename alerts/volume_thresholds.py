...
VOLUME_THRESHOLDS = [
    (100_000_000, 1.3),  # Якщо avg > 100М, то алерт при 1.3x
    (50_000_000, 1.5),   # Якщо avg > 50М, то алерт при 1.5x
    (30_000_000, 1.5),   # Якщо avg > 30М, то алерт при 1.5x
    (10_000_000, 2.0),   # Якщо avg > 10М, то алерт при 2x
    (0, 5.0),            # Інакше алерт при 5x
]
